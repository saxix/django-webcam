...
project = u'Django Webcam Fields'
...
htmlhelp_basename = 'djangowebcamfields'
...
latex_documents = [
    ('index', 'DjangoWebcamFields.tex', u"Django Admin Actions Documentation",
...
man_pages = [
    ('index', 'djangowebcamfields', u"Django Webcam Fields Documentation",
